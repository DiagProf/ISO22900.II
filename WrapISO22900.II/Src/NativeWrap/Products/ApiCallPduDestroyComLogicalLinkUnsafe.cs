...
namespace ISO22900.II
{
    ...
    internal class ApiCallPduDestroyComLogicalLinkUnsafe : ApiCallPduDestroyComLogicalLink
    {
        internal override void PduDestroyComLogicalLink(uint moduleHandle, uint comLogicalLinkHandle)
        {
            CheckResultThrowException(PDUDestroyComLogicalLink(moduleHandle, comLogicalLinkHandle));
        }

        internal ApiCallPduDestroyComLogicalLinkUnsafe(IntPtr handleToLoadedNativeLibrary) : base(handleToLoadedNativeLibrary)
        {
        }

        // should look like the C function as much as possible.
        // ReSharper disable InconsistentNaming
        private unsafe PduError PDUDestroyComLogicalLink(UNUM32 hMod, UNUM32 hCLL)
        {
            return ((delegate* unmanaged[Stdcall]<UNUM32, UNUM32, PduError>) AddressOfNativeMethod)(hMod, hCLL);
        }
